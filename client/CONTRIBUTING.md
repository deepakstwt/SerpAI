# Contributing to SerpAI

First off, thank you for considering contributing to SerpAI! It's people like you that make SerpAI such a great tool.

## Where do I go from here?

If you've noticed a bug or have a feature request, make sure to check our [Issues](https://github.com/GreatStackDev/serpai/issues) page to see if someone else has already created a ticket. If not, go ahead and [make one](https://github.com/GreatStackDev/serpai/issues/new)!

## Fork & create a branch

If this is something you think you can fix, then fork SerpAI and create a branch with a descriptive name.
